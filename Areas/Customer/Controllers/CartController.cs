...
namespace Projekt.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            // Tilldela ApplicationUserId till OrderHeader baserat på inloggad användare
        ...
        private double GetPriceBasedOnQuantity(ShoppingCart shoppingCart)
        {
            ...
            {
                return shoppingCart.Product.Price ?? 0;
            }
            else if (shoppingCart.Count <= 10)
            {
                return shoppingCart.Product.Price50 ?? 0;
            }
            else
            {
                return shoppingCart.Product.Price100 ?? 0;
            }
        }
